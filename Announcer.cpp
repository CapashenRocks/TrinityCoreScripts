...
namespace
{
    std::string GetClassColored(Player* player)
    {
        ...
        default:                 return "|cffFF0000Redacted Class|r";
        }
    }
    ...
    std::string GetRaceColored(Player* player)
    {
        ...
        {
        case RACE_HUMAN:         return "|cff00ff00Human|r";               // 1
        case RACE_ORC:           return "|cff00ff00Orc|r";                 // 2
        case RACE_DWARF:         return "|cff00ff00Dwarf|r";               // 3
        case RACE_NIGHTELF:      return "|cff00ff00Night Elf|r";           // 4
        case RACE_UNDEAD_PLAYER: return "|cff00ff00Undead|r";              // 5
        case RACE_TAUREN:        return "|cff00ff00Tauren|r";              // 6
        case RACE_GNOME:         return "|cff00ff00Gnome|r";               // 7
        case RACE_TROLL:         return "|cff00ff00Troll|r";               // 8
        case RACE_GOBLIN:        return "|cff00ff00Goblin|r";              // 9 
        case RACE_BLOODELF:      return "|cff00ff00Blood Elf|r";           // 10
        case RACE_DRAENEI:       return "|cff00ff00High Elf|r";            // 11 
        //case 12:                 return "|cff00ff00Fel Orc|r";             
        case RACE_WORGEN:                 return "|cff00ff00Worgen|r";              
            // For future xpac ports:
        case 25:                 return "|cff00ff00Pandaren|r";
        case 26:                 return "|cff00ff00Pandaren|r";
        case 27:                 return "|cff00ff00Nightbourne|r";
        case 28:                 return "|cff00ff00Highmountain Tauren|r";
        case 29:                 return "|cff00ff00Void Elf|r";
        case 30:                 return "|cff00ff00Lightforged Draenei|r";
        case 31:                 return "|cff00ff00Zandalari Troll|r";
        case 32:                 return "|cff00ff00Kul Tiran|r";
        case 34:                 return "|cff00ff00Dark Iron Dwarf|r";
        case 35:                 return "|cff00ff00Vulpera|r";
        case 36:                 return "|cff00ff00Mag'har Orc|r";
        case 37:                 return "|cff00ff00Mechagnome|r";
        case 52:                 return "|cff00ff00Dracthyr|r";
        case 70:                 return "|cff00ff00Dracthyr|r";
        case 84:                 return "|cff00ff00Earthen Dwarf|r";
        case 85:                 return "|cff00ff00Earthen Dwarf|r";
        default:                 return "Unknown Race";
        }
    }

    std::string ColorName(Player* player)
    {
        return "|cff00ff00" + std::string(player->GetName()) + "|r";
    }
    ...
    std::string GetPlayerZone(Player* player)
    {
        ...
        if (!zoneEntry)
            return "|cff00ff00Deep in the Wilderness|r";

        LocaleConstant locale = DEFAULT_LOCALE;
        if (WorldSession* session = player->GetSession())
            locale = session->GetSessionDbcLocale();
    ...
    void SendSpyMessage(Player* player, bool login)
    {
        ...
        if (login)
        {
            msg = "Local spies report that a " + race + " " + cls + " named " +
                name + " has logged in near " + area +
                "! Intelligence indicates they are loyal to the " + faction + ".";
        }
        else
        {
            msg = "Local spies report that a " + race + " " + cls + " named " +
                name + " has logged out from " + area +
